...
import type { Language, Theme, ChatSession } from '../types';
import { XMarkIcon, Cog6ToothIcon, BellIcon, ClockIcon, LinkIcon, CircleStackIcon, ShieldCheckIcon, UserCircleIcon, ChevronUpDownIcon, PlayIcon, PencilSquareIcon, CpuChipIcon, ChevronRightIcon, GoogleDriveIcon, OneDriveIcon, ArchiveBoxIcon, TrashIcon, ArrowDownOnSquareIcon, HelpIcon } from './icons';
...
const SettingsModal: React.FC<SettingsModalProps> = ({ 
  ...
  const SettingsSection: React.FC<{title: string; children: React.ReactNode;}> = ({ title, children }) => (
    <div className="border-b border-isocio-gray-200 dark:border-isocio-gray-700 pb-6 mb-6">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" onClick={onClose}>
      <div className="bg-white dark:bg-isocio-gray-900 rounded-xl shadow-2xl w-full max-w-4xl h-[70vh] flex overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="w-1/3 md:w-1/4 border-e border-isocio-gray-200 dark:border-isocio-gray-800 p-4">
